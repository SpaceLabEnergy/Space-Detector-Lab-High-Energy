...
def linear_fit_odr(energies, channels, channel_err, name):
    ...
    ChatGPT adjusted my linear fit function to include uncertainties using
    scipy.odr
...
def energy_resolution(channels, channel_errors, fwhm, fwhm_err, slope, slope_err, intercept, intercept_err, detector):
    ...
    it to a resolution model including uncertainty propagation (ChatGPT
    helped with error propagation).
